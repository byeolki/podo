...
export default function RadioModal({ playlistId, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60" onClick={onClose}>
      <div
        className="bg-surface-2 border border-border rounded-xl w-full max-w-md max-h-[min(85vh,760px)] flex flex-col shadow-overlay"
      ...
      >
        ...
        <div className="p-4 overflow-y-auto space-y-2">
          ...
          {isLoading ? (
            ...
            <p className="text-xs text-ink-faint text-center py-4">No radio URLs created yet</p>
          ) : (
            activeTokens.map((t) => (
